...
Router.route('/results/:type/:location/:range', function() {
  this.render("results"); 
},{
  ...
  data: function(){
      ...
      var areaLocation = this.params.location;
      ...
      return {      
        selectedHospitals: Hospitals.find({area: areaLocation, types:types[0].typesName:hospType, consultation_fee: { $lt: fee } }).fetch(),
